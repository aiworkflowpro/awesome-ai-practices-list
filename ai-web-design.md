# AI Web & Product Design — real-world best practices
...
### [Android app detects smart glasses via Bluetooth signatures](https://digestops.com/p/android-app-detects-smart-glasses-via-bluetooth-signatures-46)
*by [@ProtonPrivacy](https://x.com/ProtonPrivacy) · 1354 likes · [source](https://x.com/ProtonPrivacy/status/2072367269322113269)*
...
### [Polydao used Claude Code with custom design skills to build a premium site in 4 minutes.](https://digestops.com/p/polydao-used-claude-code-with-custom-design-skills-to-build-30)
*by [@polydao](https://x.com/polydao) · 636 likes · [source](https://x.com/polydao/status/2071515766109732890)*

- Custom design skills in Claude Code can produce high-quality results faster than generic generators.
...
- Used Awwwards and Pinterest references section by section for design.
- Installed design skills, dropped references into a folder, wrote one detailed build prompt.
...
- The app turns an iPhone into a dumbphone with a click wheel and 15 mini apps.
...
### [Abmankendrick used Figma Make to turn Figma designs into realistic prototypes with a step-by-step process.](https://digestops.com/p/abmankendrick-used-figma-make-to-turn-figma-designs-into-31)
*by [@Abmankendrick](https://x.com/Abmankendrick) · 485 likes · [source](https://x.com/Abmankendrick/status/2019690498588377393)*

- Prepare your Figma design by selecting the screens you want to prototype.
- Send the selected screens to Figma Make and enter a prompt to generate a prototype.
- The prototype stays true to your original design and is generated in seconds.
